# Advanced Vehicle Rental System Fivem ESX/QB/QBX Framework

**The ultimate vehicle rental experience for FiveM servers.** This script completely revamps the vehicle rental activity with a sleek, interactive UI, a comprehensive deposit system with damage detection, and immersive NPC dialogues. Powered by `ak47_lib`, it features multi-framework support, dynamic categories, and late return penalties.

---

## 🎥 Showcase

> **[Click here to watch the full feature showcase on YouTube](https://youtu.be/YnYLrLitzkw)**
...
* ak47_lib: [https://github.com/MenanAk47/ak47_lib/releases/latest](https://github.com/MenanAk47/ak47_lib/releases/latest)

---

## ⚙️ How To Install:

* Download ak47_rentalcar from your cfx portal.
